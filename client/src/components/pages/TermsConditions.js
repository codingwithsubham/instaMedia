  ...
  return (
    <div className="terms-conditions">
      ...
      <p>
        ...
        instaMedia Works App.
      </p>{" "}
      <p>
        instaMedia Works is committed to ensuring that the app is as useful and
      ...
      <p>
        The instaMedia Works app stores and processes personal data that you have
        ...
        features and it could mean that the instaMedia Works app won't work
        properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that instaMedia Works
      ...
      <p>
        Along the same lines, instaMedia Works cannot always take responsibility
        ...
        avail the Service, instaMedia Works cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to instaMedia Works’s responsibility for your use of the
        ...
        we can make it available to you. instaMedia Works accepts no liability
      ...
      <p>
        ...
        updates if you want to keep using the app. instaMedia Works does not
